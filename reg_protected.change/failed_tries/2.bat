...
:: -------------------------------
set "BATCH_PATH=%~f0"
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "$s=[System.IO.File]::ReadAllText($env:BATCH_PATH); Invoke-Expression $s.Substring($s.IndexOf('===PS_START===')+14)"
exit /b %errorlevel%
